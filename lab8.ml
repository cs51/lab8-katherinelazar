...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let x = new_id () in
    let waiter = {id = x; action = listener} in
    evt := !evt @ [waiter]; x ;;
...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    ...
    | [] -> lst
    | hd :: tail ->
      if hd.id = i then remove_listener tail else
        hd :: remove_listener tail) in
    evt := ref lst ;;
...
let id1 = WEvent.add_listener(newswire, buzzFake);;
let id2 = WEvent.add_listener(newswire, fakeNewsNetwork);;
...
let receive_report (str: string) : () =
  ...
  ignore (WEvent.add_listener publish (fun () -> fakeNewsNetwork str));;
(*......................................................................
...
receive_report h4; receive_report h5; receive_report h6;;
